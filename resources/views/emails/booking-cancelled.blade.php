...
## 💶 Informazioni sul rimborso
La tua richiesta di annullamento è stata elaborata. Abbiamo emesso un **rimborso di {{ number_format($booking->refund_amount, 2, ',', '') }}€**, al netto della penale prevista dai nostri termini di servizio.
...
## ⚠️ Pagamento penale
A seguito dell'annullamento, è stata applicata una **penale di {{ number_format($booking->penalty_amount, 2, ',', '') }}€**, come previsto dai nostri termini di servizio.
