...
**Attenzione:** Il sistema ha calcolato una **penale di {{ number_format($booking->penalty_amount, 2, ',', '') }}€** a carico del cliente. Il cliente è stato avvisato di procedere con il pagamento tramite dashboard.
@endif
