...
abbiamo ricevuto correttamente i documenti caricati per la prenotazione <code class="booking">#{{ $booking->id }}</code>.

Il nostro team verificherà la correttezza dei file caricati nelle prossime ore.

Riceverai una notifica via mail non appena la pratica sarà approvata.
