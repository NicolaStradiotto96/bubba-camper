                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <a href="https://wa.me/393347538083"
                            class="flex items-center p-4 bg-green-100 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl hover:shadow-md hover:border-green-300 hover:bg-green-200 dark:hover:border-green-500 dark:hover:bg-green-900/40 focus:outline-none focus:ring-2 focus:ring-amber-500 transition"
                            target="_blank">
