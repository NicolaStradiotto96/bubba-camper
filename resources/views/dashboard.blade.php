        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div
                    ...
                    <div
                        class="mt-8 p-4 bg-amber-100 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                        <p class="text-amber-700 dark:text-amber-400">Non hai ancora prenotazioni attive. Scegli le
                            date
                            FF e parti!</p>
