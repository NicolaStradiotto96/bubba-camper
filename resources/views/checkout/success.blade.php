            ...
            <div
                ...
                @if (
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-amber-800 dark:text-amber-500 mb-2 uppercase animate-pulse">
                            <i class="fa-solid fa-file-arrow-up mr-2"></i> Completa la tua pratica
                        </h3>
                        <p class="text-gray-700 dark:text-gray-300 text-sm mb-4">
                            Per finalizzare la prenotazione, carica una copia della tua carta d'identità e della patente
                            di
                            guida.
                        </p>
