...
return [
    ...
    [
        ...
        'a' => 'Puoi leggere il contratto di noleggio completo online oppure scaricarlo in formato PDF:',
        'link' => ['url' => 'contracts/v1/Contratto-Noleggio.pdf', 'text' => 'Visualizza Contratto PDF', 'title' => "Scarica il PDF della polizza assicurativa"]
    ],
    [
        'q' => 'Dove posso consultare la polizza assicurativa?',
        'a' => 'Puoi visualizzare la polizza assicurativa o scaricarla in formato PDF:',
        'link' => ['url' => 'contracts/v1/Polizza-Assicurativa.pdf', 'text' => 'Visualizza Polizza Assicurativa PDF', 'title' => "Scarica il PDF del contratto di noleggio"]
    ],
];
