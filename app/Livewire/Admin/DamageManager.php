...
class DamageManager extends Component
{
    ...
    public function saveDamage()
    {
        ...
        return redirect()->route('damage.index')->with('swal-success', $isUpdate ? "Danno <span class='damage-id'>#{$damage->id}</span> aggiornato con successo!" : "Danno <span class='damage-id'>#{$damage->id}</span> segnalato con successo!");
    }
